...
// 在官方 sdk 基础上，增加 parameter，用于传送 request body
func (client *Client) CreateRepo(requestBody interface{}) (_result *CreateRepoResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &CreateRepoResponse{}
	_body, _err := client.CreateRepoWithOptions(headers, requestBody, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) CreateRepoWithOptions(headers map[string]*string, requestBody interface{}, runtime *util.RuntimeOptions) (_result *CreateRepoResponse, _err error) {
